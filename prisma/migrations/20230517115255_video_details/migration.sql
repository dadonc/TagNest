...
INSERT INTO "new_Item" ("bookmarkId", "createdAt", "fileId", "getsCurrentlyImported", "id", "importStep", "name", "note", "type", "updatedAt", "url") SELECT "bookmarkId", "createdAt", "fileId", "getsCurrentlyImported", "id", "importStep", "name", "note", "type", "updatedAt", "url" FROM "Item";
DROP TABLE "Item";
